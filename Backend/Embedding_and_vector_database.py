...
def get_closest_documents(cognito_user_id: str, query: str, match_threshold=MATCH_THRESHOLD, match_count=MATCH_COUNT):
    """
    ...
    query_embedding_list = query_embedding.tolist() if not isinstance(query_embedding, list) else query_embedding
